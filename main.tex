...
\includegraphics[width=0.2\textwidth]{logo_redbg.png}\\[1em]
\vspace{0.5em}
...
Componente Connessa nasce dall’esigenza \textbf{concreta} di unire le diverse realtà di rappresentanza presenti all’interno del Dipartimento di Informatica in un unico progetto condiviso. Ci proponiamo come una lista \textbf{apartitica} e \textbf{indipendente} da sindacati boh porco dio fuori la chiesa, focalizzata \textbf{esclusivamente} sull’ascolto e sulla risoluzione dei reali problemi del 
x2% cambiamo il focus su ascolto e poi diciamo che siamo indipendenti in maniera velata %
Dipartimento.
...
\begin{itemize}
    \item Un approccio inclusivo, apolitico e apartitico, aperto a chiunque voglia contribuire attivamente alla rappresentanza
    \item Ascolto continuo degli studenti, attraverso momenti di confronto e spazi dedicati al dialogo
    \item Raccolta e valutazione costante dei feedback, con particolare attenzione ai singoli corsi e alle loro criticità
\end{itemize}

\section{Le nostre proposte}
\subsection{Questionari Post-Esame}
Nell’ultimo anno abbiamo promosso l’introduzione dei questionari post-esame per affiancare gli strumenti di valutazione esistenti e ottenere un’analisi più completa dei corsi. Proponiamo di consolidarne e ampliarne l’utilizzo, lavorando per un loro riconoscimento formale e per l’integrazione nei processi di valutazione della didattica, anche tramite la Commissione Paritetica, al fine di raccogliere dati più rappresentativi e migliorare concretamente la qualità dei corsi.
...
Riteniamo fondamentale migliorare o le attività di tutoraggio, in particolare per gli insegnamenti caratterizzati da un alto tasso di difficoltà e di non superamento degli esami.
\\Proponiamo di incrementare il numero di tutoraggi, valorizzando il ruolo degli studenti tutor, al fine di offrire un supporto più accessibile e mirato. L’obiettivo è accompagnare gli studenti nel percorso di apprendimento, riducendo le difficoltà e migliorando le percentuali di superamento degli esami.
